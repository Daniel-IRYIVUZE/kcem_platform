...
const roleConfigs: Record<string, {
  ...
  business: {
    ...
    navItems: [
      ...
      { path: '/dashboard/business/messages', label: 'Messages', icon: <MessageSquare size={20} />, badge: 2 },
  ...
  recycler: {
    ...
    navItems: [
      ...
      { path: '/dashboard/recycler/collections', label: 'Active Collections', icon: <Route size={20} />, badge: 4 },
  ...
  driver: {
    ...
    navItems: [
      ...
      { path: '/dashboard/driver/assignments', label: 'My Assignments', icon: <ClipboardList size={20} />, badge: 2 },
