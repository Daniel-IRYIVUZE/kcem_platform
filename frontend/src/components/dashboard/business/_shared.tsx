...
export const StatusBadge = ({ status }: { status: string }) => {
  ...
  const styles: Record<string, string> = {
    ...
    assigned: 'bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-300', accepting: 'bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300', closed: 'bg-indigo-100 dark:bg-indigo-900/30 text-indigo-800 dark:text-indigo-300', collected: 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-200', missed: 'bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-200',
